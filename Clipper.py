...
# model_path = 'e:/epoch_45.pth'                     # 模型路径
# model_path = 'e:/epoch_39.pth'
# model_path = 'e:/epoch_43.pth'
model_path = 'e:/epoch_60.pth'
...
class Manager(object):
    ...
    def __init__(self,
        ...
        # 定义模型, 放入device, 加载权重
        self.net = Net(num_cls=20, input_size=224).to(device)
...
if __name__ == '__main__':
    ...
    clipper = Clipper(root='g:/fr_0726_test',
                      dst_dir='e:/pick_car_roi_6',
                      is_resume=True)

    process_clipped(src_root='e:/pick_car_roi_6',
